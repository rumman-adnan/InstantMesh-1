...
CONFIG_PATH="/home/rumman/projects/Instantmesh/InstantMesh/configs/instant-mesh-large.yaml"
IMG_DIR="/home/rumman/projects/Instantmesh/InstantMesh/examples/ecommerce2/"
IMG_OUPUT="/home/rumman/projects/Instantmesh/InstantMesh/outputs/instant-mesh-large/images1/"
VIDEO_PATH="/home/rumman/projects/Instantmesh/InstantMesh/outputs/instant-mesh-large/videos1/"
MESH_PATH="/home/rumman/projects/Instantmesh/InstantMesh/outputs/instant-mesh-large/meshes1/"
TEXTURE_OUTPUT=MESH_PATH+"texmap/"
VIDEO_FLAG=True
...
print(f"args.config : {CONFIG_PATH}")
...
# if os.path.exists(vide_path(.mp4)):
#     continue
...
imgs_files=os.listdir(IMG_DIR)
imgs_files.sort()
print(f"{imgs_files} | total : {len(imgs_files)}")


for idx,imgs_file in enumerate(imgs_files) :
    t1=time.time()
    pipeline=create_pipeline()
    img_path=IMG_DIR+ imgs_file # os.path.join(IMG_DIR,imgs_file)
        ...
        for idx, sample in enumerate(outputs):
            ...
            with torch.no_grad():
                ...
                mesh_out = model.extract_mesh(
                    planes,
                    use_texture_map=TEXTURE_OUTPUT,
                    **infer_config,
                )
                if TEXTURE_OUTPUT:
...
print(f"TEXTURE_OUTPUT :{TEXTURE_OUTPUT}")
print(f"args.no_rembg: {args.no_rembg}")